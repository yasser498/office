      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto">
          <button
            ...
            className="flex items-center gap-2 bg-amber-50 text-amber-600 px-5 py-2.5 rounded-2xl font-black text-sm hover:bg-amber-100 transition-all border border-amber-100"
          >
            <Clock size={18} />
            سجل حصر التأخر
          </button>
